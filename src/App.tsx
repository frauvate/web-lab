  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        {/* HATA DURUMU */}
        {error && (
          <Alert variant="error" title="Hata" onClose={() => setError(null)}>
            {error}
          </Alert>
        )}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <div className="flex gap-2">
            <select 
              ...
              className="border rounded-lg px-3 py-2 dark:bg-gray-800 dark:text-white dark:border-gray-700"
            >
            ...
            <Button 
              variant="outline" 
              size="sm" 
              onClick={() => setSortOrder((o: SortOrder) => o === "asc" ? "desc" : "asc")}
            >
